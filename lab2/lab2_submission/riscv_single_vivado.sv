...
module riscvsingle (input  logic        clk, reset,
   ...
   logic 				ALUSrc, RegWrite, Jump, Zero, Negative, Carry, Overflow, jalrsig;
   logic [1:0] 				ResultSrc;
   logic [2:0]              ImmSrc; //2 to 3
   logic [3:0] 				ALUControl; //3 to 4
   
   controller c (Instr[6:0], Instr[14:12], Instr[30], Zero, Negative, Carry. Overflow,
		 ResultSrc, MemWrite, PCSrc,
		 ALUSrc, RegWrite, Jump,
		 ImmSrc, ALUControl, jalrsig, MemStrobe);
   datapath dp (clk, reset, ResultSrc, PCSrc,
		ALUSrc, RegWrite,
		ImmSrc, ALUControl,
		Zero, Negative, Carry, Overflow, PC, Instr,
		ALUResult, WriteData, ReadData, jalrsig, PCReady);
...
module controller (input  logic [6:0] op,
   ...
   maindec md (op, ResultSrc, MemWrite, Branch,
	       ALUSrc, RegWrite, Jump, ImmSrc, ALUOp, jalrsig, MemStrobe);
...
module maindec (input  logic [6:0] op,
   ...
   assign {RegWrite, ImmSrc, ALUSrc, MemWrite,
	   ResultSrc, Branch, ALUOp, Jump, jalrsig, MemStrobe} = controls;
   
     always_comb
     case(op)
       // RegWrite_ImmSrc_ALUSrc_MemWrite_ResultSrc_Branch_ALUOp_Jump_jalrsig_Memstrobe
       ...
       7'b1100011: controls = 14'b0_010_0_0_00_1_01_0_0_0; // branches (beq, bne, etc)
       ...
       7'b0010111: controls = 14'b1_100_1_0_11_0_11_0_0_0; //auipc
...
module datapath (input  logic        clk, reset,
   ...
   logic [31:0] 		     PCNext, PCPlus4, PCTarget, PCNextTemp;
   logic [31:0] 		     ImmExt;
